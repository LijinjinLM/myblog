...
suite('ejs.renderFile(path, [data], [options], fn)', function () {
  ...
  test('accept locals', function(done) {
    ...
    ejs.renderFile('test/fixtures/users.ejs', data, options, function(err, html) {
      if (err) {
        return done(err);
      }
  ...
  test('accept locals without using with() {}', function(done) {
    ...
    var doneCount = 0;
    ejs.renderFile('test/fixtures/users-no-with.ejs', data, options, function(err, html) {
      if (err) {
        if (doneCount === 2) {
          return;
        }
    ...
    ejs.renderFile('test/fixtures/users.ejs', data, options, function(err) {
      if (!err) {
        if (doneCount === 2) {
          return;
        }
