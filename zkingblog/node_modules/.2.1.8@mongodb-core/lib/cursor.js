...
/**
 * Validate if the cursor is dead but was not explicitly killed by users
 */
...
/**
 * Validate if the cursor is dead and was killed by users
 */
...
/**
 * Validate if the cursor was killed by the users
 */
  ...
  if(self.cursorState.cursorId == null) {
    ...
    return setCursorDeadAndNotified(self, callback);
      ...
      self._getmore(function(err, doc, connection) {
        ...
        // No attempt is made here to retry, this is left to the users of the
