...
router.get('/add',middleware.checkLogin, function(req, res, next) {
    ...
    res.render("article/addArticle",{title:"发表文章"});
...
router.get("/edit/:_id",function (req,res,next) {
    ...
    Model('Article').findOne({_id:articleId},function (err,article) {
        ...
        console.log(article);
        res.render('article/editArticle',{title:'查看文章',article:article});
    })
...
router.all('/list/:pageNum/:pageSize',function (req,res,next) {
    ...
    var pageSize = parseInt(req.params.pageSize) && parseInt(req.params.pageSize)>0? parseInt(req.params.pageSize) : 4;
